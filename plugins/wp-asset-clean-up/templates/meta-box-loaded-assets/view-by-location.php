    ...
    ?>
        ...
        if (! empty($data['rows_assets'])) {
            ...
            foreach ($rowsAssets as $locationMain => $values) {
	            ...
	            $hideLocationMainArea = (($locationMain === 'wp_core' && $data['plugin_settings']['hide_core_files']) ||
                                         ($locationMain === 'uploads' && $totalLocationAssets === 0));
	            ?>
	            ...
	            <?php } elseif ($locationMain === 'wp_core' && ! $data['plugin_settings']['hide_core_files']) { ?>
                    <p class="wpacu-assets-note"><strong>Note:</strong> Please be careful when doing any changes to the
	            ...
	            <?php } elseif ($locationMain === 'uploads') { ?>
